The following demonstration shows the [Application Header](application-header), [Navigation](navigation), [Menu](menu), and [Attribution](attribution) global elements within the mobile viewport.
